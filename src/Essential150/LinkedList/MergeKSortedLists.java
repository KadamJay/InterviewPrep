...
Solutions  :   https://youtu.be/q5a5OiGbT6Q
Approaches :

| No. | Approach                             | Time Complexity      | Space Complexity |
|-----|--------------------------------------|----------------------|------------------|
|  1  | Iterative                            |     O(N log k)       |       O(k)       |


The time complexity of the solution is O(N log k), where N is the total number of nodes in all 
lists and k is the number of lists. The space complexity is O(k) since the priority queue holds at most k nodes.
